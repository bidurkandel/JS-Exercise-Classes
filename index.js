...
class Airplane {
 ...
 const jonnyBonesObject = {
  name: 'JonnyBones',
  age: 28,
  location: 'Omaha',
  specialty: 'JavaScript, Python, and CSS',
  favLanguage: 'JavaScript',
  catchPhrase: 'Hello there!'
}
const jonnyBones = new Instructor(jonnyBonesObject);
console.log(jonnyBones);
...
const daneObj = {
  ...
  className: 'Python For Everybody',
  favSubjects: 'Python'
}
const dane = new Student(daneObj);
console.log(dane);
console.log(dane.graduate());
